...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------- |
| **1** | Data Monitoring Petugas Link: https://docs.google.com/spreadsheets/d/1o5KSszOIwgPrdtUv8ZOc4XfeUekJZ7xonl354GNtIUc/edit?gid=1206401506#gid=1206401506                            | Spreadsheet  | Realisasi pendataan harian PPL/PML (Bagan 1: Kolom P % Progres [Biru] & Kolom Q % Open+Draft [Kuning], Bagan 2: Kolom R % Approve [Hijau]). |
...
| **3** | Perbandingan Usaha Pertanian SE2026 vs ST2023 Link: https://docs.google.com/spreadsheets/d/19DcV3CA0FkcpsZldqd-ChW8JL0SgcVFX-dC7Y_0_3So/edit?gid=46846179#gid=46846179 | Spreadsheet  | Evaluasi perbandingan unit usaha pertanian SE2026 terhadap baseline UTP ST2023 (Desa/Kelurahan, UTP 2023, Usaha Pertanian SE2026, Persentase Realisasi). |
| **4** | Daftar Usaha Besar Kabupaten Jeneponto Link: https://docs.google.com/spreadsheets/d/18e4NwGBJy8myLvNLTVj1jV4pLpwgqZn3/edit?usp=sharing | Spreadsheet  | Direktori Usaha Besar di Jeneponto (Nama UB, Kecamatan, Alamat, Kegiatan Usaha).                                          |
| **5** | Daftar Usaha yang Datanya Bersumber dari Pusat Link: https://docs.google.com/spreadsheets/d/1BT\_ub01ex\_h3yqI-n\_EFO8pYFoVORRweB8V\_5ebpgHo/edit?usp=sharing | Spreadsheet  | Daftar usaha didata pusat (Nama Kantor Pusat).                                                                            |
| **6** | Daftar Referensi KBLI Kabupaten Jeneponto Link:                                                                                                               | Spreadsheet  | Referensi KBLI 5 digit yang sering muncul.                                                                                |
| **7** | Daftar Keluarga Khusus Link: https://docs.google.com/spreadsheets/d/1VfurEu3pLfqO0cJRiUfiB1NcY4MJGAnWWOI0pQIVAng/edit?gid=0#gid=0                            | Spreadsheet  | Daftar keluarga khusus yang perlu didata.                                                                                 |
| **8** | Materi Pelatihan Petugas SE2026 Link:                                                                                                                         | Folder drive | Folder berisi materi pelatihan petugas SE2026 (kuesioner, buku pedoman, bahan tayang).                                    |
| **9** | Weekly Briefing Link:                                                                                                                                         | Folder drive | Folder berisi bahan paparan weekly briefing.                                                                              |
