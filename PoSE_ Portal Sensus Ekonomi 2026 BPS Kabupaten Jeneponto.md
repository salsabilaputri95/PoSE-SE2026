...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------- |
| **1** | Data Monitoring Petugas Link: https://docs.google.com/spreadsheets/d/1R1UAfk_LlQM06nwiEK5_WFbIvqyTU3yjuxHlcJtf1qI/edit?gid=0#gid=0                            | Spreadsheet  | Realisasi pendataan harian PPL/PML (Nama PPL, Nama PML, Kecamatan Tugas, Muatan, Persentase submit, Persentase approved). |
