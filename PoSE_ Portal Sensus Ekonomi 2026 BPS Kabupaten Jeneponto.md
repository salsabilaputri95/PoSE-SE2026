...
* **Dua Grafik Stacked Bar (0% – 100%)**:
  * Grafik 1: Progres Tindak Lanjut PPL (per Kecamatan atau per PPL).
  * Grafik 2: Progres Pemeriksaan PML (per Kecamatan atau per PML).
  * Kategori Warna: 🔴 *Belum Ditindaklanjuti*, 🟡 *Sudah Ditindaklanjuti dg Catatan/Penjelasan*, 🟢 *Sudah Ditindaklanjuti dg Perbaikan*.
  * Fitur ekspansi memanjang ke bawah dinamis.
